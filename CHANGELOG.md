...
## [0.5.2](https://github.com/CDCgov/ixa/compare/ixa-v0.5.1...ixa-v0.5.2) - 2026-02-09

### Fixed

- use pre-commit, not pipx:pre-commit ([#728](https://github.com/CDCgov/ixa/pull/728))
- Pin the MDBook preprocessor versions. Fixes #696. ([#697](https://github.com/CDCgov/ixa/pull/697))

### Other

- bump release-plz/action from 0.5.121 to 0.5.124 ([#669](https://github.com/CDCgov/ixa/pull/669))
...
- add print execution stats fn ([#663](https://github.com/CDCgov/ixa/pull/663))
- add tests for reservoir functions ([#664](https://github.com/CDCgov/ixa/pull/664))

## [0.5.0](https://github.com/CDCgov/ixa/compare/ixa-v0.4.4...ixa-v0.5.0) - 2025-12-29

### Added

- enable negative time ([#633](https://github.com/CDCgov/ixa/pull/633))

### Other

- profiling should not print if --no-stats flag is set. ([#654](https://github.com/CDCgov/ixa/pull/654))
