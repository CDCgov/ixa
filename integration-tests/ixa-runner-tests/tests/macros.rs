...
mod tests {
    ...
    fn compile_and_run_macros() {
        ...
        let mut derived_float_both = std::collections::HashSet::new();
        ...
        let mut derived_float_neither = std::collections::HashSet::new();
