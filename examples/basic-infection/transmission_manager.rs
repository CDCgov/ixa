...
fn attempt_infection(context: &mut Context) {
    ...
    //Here, we use a per-person force of infection (FOI) derived from the population-level force of infection to represent a constant risk of disease for individuals in the population.
