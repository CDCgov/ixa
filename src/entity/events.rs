...
mod tests {
    ...
    use super::*;
    use crate::{all, define_derived_property, define_entity, define_property, Context};
    ...
    fn observe_entity_addition() {
        ...
        let _ = context
            .add_entity(all!(Person, Age(18), RunningShoes(33), RiskCategory::Low))
            .unwrap();
        context.execute();
        assert!(*flag.borrow());
    }
    ...
    fn observe_entity_property_change() {
        ...
        let person_id = context
            .add_entity(all!(Person, Age(9), RunningShoes(33), RiskCategory::Low))
            .unwrap();
    ...
    fn get_entity_property_change_event() {
        let mut context = Context::new();
        let person = context
            .add_entity(all!(Person, Age(17), RunningShoes(33), RiskCategory::Low))
            .unwrap();
