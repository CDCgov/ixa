...
mod test {
    ...
    use crate::{
        context::Context, define_derived_property, define_global_property, define_person_property,
        define_person_property_with_default, error::IxaError, people::PeoplePlugin,
